...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "T3 Roofing & Construction | Two Rivers, WI" },
      { name: "description", content: "T3 Roofing Connect is a web application for a local roofing and construction company." },
      { property: "og:description", content: "T3 Roofing Connect is a web application for a local roofing and construction company." },
      { name: "twitter:description", content: "T3 Roofing Connect is a web application for a local roofing and construction company." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fd1364a8-df91-41e6-afb4-048651bb69ff/id-preview-d32976bf--2086f503-1e05-4281-96ce-b822ca9d6093.lovable.app-1780003893716.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fd1364a8-df91-41e6-afb4-048651bb69ff/id-preview-d32976bf--2086f503-1e05-4281-96ce-b822ca9d6093.lovable.app-1780003893716.png" },
    ],
    links: [
      {
        rel: "stylesheet",
