...
function Wordmark() {
  return (
    <Link to="/" className="flex items-baseline gap-2 group">
      <span className="text-3xl md:text-4xl leading-none font-[var(--font-display)] text-primary group-hover:text-accent transition-colors">
        T3
      </span>
      <span className="hidden sm:inline text-[10px] md:text-xs uppercase tracking-[0.2em] text-muted-foreground">
