...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-navy">
      <TopBar />
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-8">
        ...
        <nav className="hidden md:flex items-center gap-7">
          {NAV.map((item) => (
            <Link
              key={item.to}
              to={item.to}
              className="text-sm uppercase tracking-[0.08em] font-semibold text-cream/85 hover:text-accent transition-colors"
        ...
        <div className="flex items-center gap-2">
          <a
            href={SITE.phoneHref}
            className="hidden lg:inline-flex items-center gap-2 text-sm font-bold text-cream hover:text-accent transition-colors"
          >
          ...
          <Link
            to="/contact"
            className="hidden md:inline-flex items-center gap-2 bg-accent px-4 py-2.5 text-sm font-bold uppercase tracking-[0.04em] text-white hover:bg-accent-hover transition-colors"
          >
            Free Estimate
          </Link>
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
              <button
                ...
                className="md:hidden inline-flex items-center justify-center border border-cream/30 p-2 text-cream"
              >
